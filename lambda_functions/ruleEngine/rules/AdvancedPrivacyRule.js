...
exports.AdvancedPrivacyRule = void 0;
class AdvancedPrivacyRule {
    constructor() {
        this.id = "ADVANCED001";
        this.description = "Advanced Privacy Compliance - Complex data-flow and context-aware violations";
    }
    evaluate(content, filePath) {
        const violations = [];
        const lines = content.split('\n');
        // Field-level access scoping violations
        const fieldScopingPatterns = [
            {
...
exports.AdvancedPrivacyRule = AdvancedPrivacyRule;
